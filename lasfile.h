...
public:
    ...
    quint16 headerSize();
    quint32 offsetToPointData();
    quint32 numberOfVLRs();
    quint32 numberOfEVLRs();
    quint8 pointFormat();
    quint16 pointRecordLength();
    quint16 standardPointRecordLength();
    quint64 numberOfPoints();
    quint32 numberOfPointByReturnFields();
    quint64 pointsByReturn(qint64 n);
    double getX0();
    double getY0();
    double getZ0();
    double getX1();
